...
namespace VRWeaponInteractor
{
	...
	public class VRGunSlide : VRSecondHeld 
	{
		...
		override protected void Step()
		{
			...
			if (heldBy != null)
			{
				...
				} else
				{
					...
					if (onlyLockSlideWithMag && gunHandler.currentMagazine != null && _pulled && !gunHandler.hasBullet)
		...
		{
			if (gunHandler.hasBullet || (item.localPosition != pulledPosition && (!onlyLockSlideWithMag || (gunHandler != null && (gunHandler.currentMagazine == null || gunHandler.currentMagazine.bulletCount != 0) && pulled))))
				Release();
